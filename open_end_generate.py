...
def eval_loop(_args):
    ...
    if _args.method == "First-Stage_Reasoning":
        # ✅ Inject generated rationales back into the JSON as 'solution'
        # so Second-Stage can use them as input
        ...
        # Save to output_dir/First-Stage_Reasoning/train.json or test.json
